		...
		if client then
			...
			if exports.players:takeMoney( client, getVehiclePrice( source ) ) then
				...
				if vehicle then
					...
					-- tell him
					outputChatBox( "Felicitaciones! Compraste un " .. getVehicleName( vehicle ) .. "!", client, 255, 127, 0 )
					outputChatBox( "Puede usar /park para establecer una posición de generación permanente para este vehículo.", client, 255, 255, 0 )
