			...
			if isLoggedIn( source ) and isValidLanguage( flag ) then
				...
				if p[ source ].languages[ flag ] then
					...
					if getCurrentLanguage( source ) == flag then
						outputChatBox( "Estas hablando actualmente en: " .. getLanguageName( flag ) .. ".", source, 0, 255, 0 )
					else
						...
						if saveLanguages( source, p[ source ].languages ) then
							...
							outputChatBox( "Ahora estas hablando en: " .. getLanguageName( flag ) .. ".", source, 0, 255, 0 )
						end
					end
				end
			end
