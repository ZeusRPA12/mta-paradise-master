...
item_list =
{
	{ name = "Llaves del vehiculo", image = true },
	{ name = "Llaves de la Casa", image = true },
	{ name = "Comida", image = getFoodImage },
	{ name = "Bebida", image = getDrinkImage },
	{ name = "Ropas", image = function( value, name ) if value then return ":players/images/skins/" .. value .. ".png" end end },
	{ name = "Tarjeta de Debito", image = true },
	{ name = "Telefono", image = true },
